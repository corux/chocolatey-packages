...
Install-ChocolateyPackage -PackageName $packageName -FileType 'exe' -SilentArgs $silentArgs -Url $url -Url64bit $url64 -Checksum $checksum -ChecksumType 'sha256' -Checksum64 $checksum64 -ChecksumType64 'sha256'
